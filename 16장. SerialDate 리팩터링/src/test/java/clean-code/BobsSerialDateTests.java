...
public class BobsSerialDateTests extends TestCase {
    ...
    public void testStringToWeekdayCode() throws Exception {
        ...
        assertEquals(MONDAY,stringToWeekdayCode("monday")); // step01 : 대소문자 구분 없이 모두 통과해야함
        assertEquals(MONDAY,stringToWeekdayCode("MONDAY"));
        assertEquals(MONDAY, stringToWeekdayCode("mon"));
    ...
    public void testStringToMonthCode() throws Exception {
        ...
        assertEquals(-1, stringToMonthCode("0"));   // step02 : 범위 밖의 값이 들어올 경우 -1 반환
        ...
        assertEquals(1,stringToMonthCode("jan"));   // step02 : 대소문자 구분 없이 모두 통과해야함
    ...
    public void testGetFollowingDayOfWeek() throws Exception {
        assertEquals(d(1, JANUARY, 2005),getFollowingDayOfWeek(SATURDAY, d(25, DECEMBER, 2004)));   // step03 : 버그 수정 (연말 -> 연초 넘어갈 때)
    ...
    public void testGetNearestDayOfWeek() throws Exception {
        ...
        assertEquals(d(17, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(16, APRIL, 2006)));  // step04 : 버그 수정 (과거 날짜만 나오는 문제)
